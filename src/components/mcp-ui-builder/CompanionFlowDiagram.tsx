  ...
  return (
    <div className="relative p-6 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/10 dark:to-amber-950/10 rounded-lg border">
      ...
      <div className="flex justify-center mb-6">
        <div className="flex flex-col items-center space-y-2">
          <div className="w-64 h-24 bg-orange-100 dark:bg-orange-900/30 rounded-lg border-2 border-orange-500 flex flex-col items-center justify-center p-3 shadow-lg">
            <Layers className="h-6 w-6 text-orange-600 mb-1" />
      ...
      <div className="flex justify-center">
        <div className="flex flex-col items-center space-y-2">
          <div className="w-48 h-16 bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/30 dark:to-amber-900/30 rounded-lg border-2 border-orange-500 flex items-center justify-center p-3 shadow-lg">
